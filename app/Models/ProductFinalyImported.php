...
class ProductFinalyImported extends Model
{
   ...
   protected $fillable = ["product_finaly_id","guide_refer_id","product_finaly_created","product_finaly_provider","product_finaly_money","product_finaly_hist_bill","product_finaly_hist_guide","product_finaly_type_change","product_finaly_amount","product_finaly_price_buy","product_finaly_total_buy","product_finaly_user"];
   ...
   public function scopeGetActive($query,$productFinalyId) {
      return $query->select("provider_name",'guide_refer_id',"product_finaly_amount","product_finaly_imported.id","product_unit_measurement","product_finaly_money","product_finaly_hist_bill","product_finaly_hist_guide","product_finaly_price_buy","product_finaly_total_buy")
