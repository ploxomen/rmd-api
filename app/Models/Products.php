...
class Products extends Model
{
    ...
    public static function getProducts($search){
        return Products::select("products.id","product_code","product_buy","product_public_customer","product_distributor","sub_categorie_name","categorie_name","product_name")
